CLASS /atrm/cl_object_gsmp DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_gsmp IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'GSMP'.
        ...
        ASSIGN COMPONENT 'IMPLEMENTATION-TYPE' OF STRUCTURE <ls_content>
          TO <lv_object>.
        CHECK sy-subrc = 0.
        CHECK <lv_object> IS NOT INITIAL.

        ASSIGN COMPONENT 'IMPLEMENTATION-NAME' OF STRUCTURE <ls_content>
          TO <lv_obj_name>.
        CHECK sy-subrc = 0.
      ...
      CATCH cx_root.
        " optional metric provider API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
