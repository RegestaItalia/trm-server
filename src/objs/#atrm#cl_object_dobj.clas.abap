CLASS /atrm/cl_object_dobj DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_dobj IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    FIELD-SYMBOLS:
      ...
      <lt_relations>   TYPE ANY TABLE,
      <ls_relation>    TYPE any,
      <lv_table_name>  TYPE any.

    TRY.
        ls_object_type-objtype_tr = 'DOBJ'.
        ls_object_type-subtype_wb = 'DST'.
        ...
        ASSIGN COMPONENT 'DESTRUCTION_CLASS' OF STRUCTURE <ls_content>
          TO <lv_class_name>.
        ...
        ASSIGN COMPONENT 'STRUCTURE_DEFINITION' OF STRUCTURE <ls_content>
          TO <lt_relations>.
        IF sy-subrc = 0.
          LOOP AT <lt_relations> ASSIGNING <ls_relation>.
            ASSIGN COMPONENT 'PARENT_TABLE' OF STRUCTURE <ls_relation>
              TO <lv_table_name>.
            IF sy-subrc = 0 AND <lv_table_name> IS NOT INITIAL.
              TRY.
                  CLEAR ls_dependency.
                  CALL METHOD get_tadir_dependency
            ...
            ASSIGN COMPONENT 'DEPENDENT_TABLE' OF STRUCTURE <ls_relation>
              TO <lv_table_name>.
            IF sy-subrc = 0 AND <lv_table_name> IS NOT INITIAL.
              TRY.
                  CLEAR ls_dependency.
        ...
        ENDIF.
      CATCH cx_root.
        " optional destruction object API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
