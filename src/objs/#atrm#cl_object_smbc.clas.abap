CLASS /atrm/cl_object_smbc DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_smbc IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'SMBC'.
        ...
        ASSIGN COMPONENT 'SERVICE_CONFIGURATION-SERVICE_BINDING'
          OF STRUCTURE <ls_content> TO <lv_obj_name>.
        IF sy-subrc = 0 AND <lv_obj_name> IS NOT INITIAL.
          TRY.
              CALL METHOD get_tadir_dependency
                EXPORTING object = 'SRVB' obj_name = <lv_obj_name>
        ...
        ASSIGN COMPONENT 'SERVICE_CONFIGURATION-SERVICE_NAME'
          OF STRUCTURE <ls_content> TO <lv_obj_name>.
        IF sy-subrc = 0 AND <lv_obj_name> IS NOT INITIAL.
          TRY.
              CLEAR ls_dependency.
        ...
        ENDIF.
      CATCH cx_root.
        " optional business configuration API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
