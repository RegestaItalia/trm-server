...
CLASS /atrm/cl_object_sql1 IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'SQL1'.
        ls_object_type-subtype_wb = 'SQL'.
        ...
        ASSIGN COMPONENT 'SERVICE_DEF_NAME' OF STRUCTURE <ls_content>
          TO <lv_obj_name>.
        CHECK sy-subrc = 0.
      ...
      CATCH cx_root.
        " optional SQL service binding API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
