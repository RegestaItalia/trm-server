CLASS /atrm/cl_object_casp DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_casp IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ...
        ENDLOOP.
      CATCH cx_root.
        " optional check-aspect API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
