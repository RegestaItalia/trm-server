CLASS /atrm/cl_object_srvc DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_srvc IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'SRVC'.
        ls_object_type-subtype_wb = 'SVM'.
        ...
        ASSIGN COMPONENT 'CONS_INFO-CONS_OBJ_TYPE' OF STRUCTURE <ls_content>
          TO <lv_object>.
        CHECK sy-subrc = 0.
        CHECK <lv_object> IS NOT INITIAL.

        ASSIGN COMPONENT 'CONS_INFO-CONS_OBJ_NAME' OF STRUCTURE <ls_content>
          TO <lv_obj_name>.
        CHECK sy-subrc = 0.
      ...
      CATCH cx_root.
        " optional service consumption API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
