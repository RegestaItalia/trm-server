...
CLASS /atrm/cl_object_sajc IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'SAJC'.
        ...
        ls_reference-path = 'GENERAL_INFORMATION-CLASS_NAME'.
        ls_reference-object = 'CLAS'.
        APPEND ls_reference TO lt_references.
        ls_reference-path = 'GENERAL_INFORMATION-PROGRAM_NAME'.
        ls_reference-object = 'PROG'.
        APPEND ls_reference TO lt_references.
        ls_reference-path = 'EXIT_CLASSES-CHECK'.
        ls_reference-object = 'CLAS'.
        APPEND ls_reference TO lt_references.
        ls_reference-path = 'EXIT_CLASSES-VALUE_HELP'.
        ls_reference-object = 'CLAS'.
        APPEND ls_reference TO lt_references.
        ls_reference-path = 'EXIT_CLASSES-NOTIFICATION'.
        ls_reference-object = 'CLAS'.
        APPEND ls_reference TO lt_references.
        ...
        ENDLOOP.
      CATCH cx_root.
        " optional application job API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
