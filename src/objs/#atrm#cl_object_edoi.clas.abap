CLASS /atrm/cl_object_edoi DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_edoi IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'EDOI'.
        ...
        ASSIGN COMPONENT 'VERSIONS' OF STRUCTURE <ls_content> TO <lt_versions>.
        CHECK sy-subrc = 0.

        LOOP AT <lt_versions> ASSIGNING <ls_version>.
          UNASSIGN <lv_obj_name>.
          ASSIGN COMPONENT 'COMMUNICATION_ATTRIBUTES-RESPONSE_INTERFACE'
            OF STRUCTURE <ls_version> TO <lv_obj_name>.
          CHECK sy-subrc = 0.
          ...
          TRY.
              ...
              CALL METHOD get_tadir_dependency
                EXPORTING object = 'EDOI' obj_name = <lv_obj_name>
        ...
        ENDLOOP.
      CATCH cx_root.
        " optional electronic document API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
