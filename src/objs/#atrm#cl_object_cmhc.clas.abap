CLASS /atrm/cl_object_cmhc DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_cmhc IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'CMHC'.
        ...
        ENDIF.
        ASSIGN COMPONENT 'IMPL_CLASS' OF STRUCTURE <ls_content> TO <lv_obj_name>.
        CHECK sy-subrc = 0.
      ...
      CATCH cx_root.
        " optional cloud health check API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
