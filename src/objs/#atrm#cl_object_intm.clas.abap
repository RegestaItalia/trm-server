CLASS /atrm/cl_object_intm DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_intm IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'INTM'.
        ...
        ASSIGN COMPONENT 'GENERAL_INFORMATION-INTELLIGENT_SCENARIO' OF STRUCTURE <ls_content>
          TO <lv_obj_name>.
        CHECK sy-subrc = 0.
        CHECK <lv_obj_name> IS NOT INITIAL.

        CALL METHOD get_tadir_dependency
          EXPORTING object = 'INTS' obj_name = <lv_obj_name>
          RECEIVING dependency = ls_dependency.
        APPEND ls_dependency TO dependencies.
      CATCH cx_root.
        " optional intelligent scenario model API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
