CLASS /atrm/cl_object_sajt DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_sajt IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'SAJT'.
        ...
        ASSIGN COMPONENT 'GENERAL_INFORMATION-CATALOG_NAME' OF STRUCTURE <ls_content>
          TO <lv_obj_name>.
        CHECK sy-subrc = 0.
        CHECK <lv_obj_name> IS NOT INITIAL.

        CALL METHOD get_tadir_dependency
          EXPORTING object = 'SAJC' obj_name = <lv_obj_name>
