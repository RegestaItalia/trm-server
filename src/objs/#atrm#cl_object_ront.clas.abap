CLASS /atrm/cl_object_ront DEFINITION
  PUBLIC
...
CLASS /atrm/cl_object_ront IMPLEMENTATION.
  ...
  METHOD /atrm/if_object~get_dependencies.
    ...
    TRY.
        ls_object_type-objtype_tr = 'RONT'.
        ls_object_type-subtype_wb = 'ROT'.
        ...
        ASSIGN COMPONENT 'INTERFACE_BEHAVIOR_DEFINITION' OF STRUCTURE <ls_content>
          TO <lv_obj_name>.
        CHECK sy-subrc = 0.
        CHECK <lv_obj_name> IS NOT INITIAL.

        CALL METHOD get_tadir_dependency
          EXPORTING object = 'BDEF' obj_name = <lv_obj_name>
          RECEIVING dependency = ls_dependency.
        APPEND ls_dependency TO dependencies.
      CATCH cx_root.
        " optional SAP object type API may not exist in the target system
    ENDTRY.
  ENDMETHOD.
