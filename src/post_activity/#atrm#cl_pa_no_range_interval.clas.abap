...
"!
CLASS /atrm/cl_pa_no_range_interval DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    "! @raising /atrm/cx_exception   | Raised if interval creation fails or input is invalid
    CLASS-METHODS pre
      IMPORTING
...
CLASS /atrm/cl_pa_no_range_interval IMPLEMENTATION.
