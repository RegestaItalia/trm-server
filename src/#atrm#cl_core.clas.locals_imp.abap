  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING iv_name     TYPE string
                ...
                is_manifest TYPE /atrm/if_core=>ty_manifest OPTIONAL
                iv_manifest TYPE xstring OPTIONAL.

    DATA: xmanifest TYPE xstring READ-ONLY,
          manifest  TYPE /atrm/if_core=>ty_manifest READ-ONLY,
...
CLASS lcl_trm_manifest DEFINITION CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING is_manifest TYPE /atrm/if_core=>ty_manifest
                iv_manifest TYPE xstring OPTIONAL.
  ...
  PRIVATE SECTION.
    ...
    DATA: gv_manifest TYPE xstring,
          gs_manifest TYPE /atrm/if_core=>ty_manifest.
...
CLASS lcl_trm_manifest IMPLEMENTATION.
  ...
  METHOD from_abap_xml.
    DATA: lv_xml      TYPE xstring,
          ls_manifest TYPE /atrm/if_core=>ty_manifest.
