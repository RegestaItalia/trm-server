...
CLASS /atrm/cl_before_export DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    "! Constructor
    "! @parameter skip | Table of checks to skip
    "! @parameter transport | Reference to the transport object
    METHODS constructor
      IMPORTING skip      TYPE tyt_skip
                transport TYPE REF TO /atrm/cl_transport.
  ...
  PRIVATE SECTION.
    ...
    DATA: gt_skip      TYPE tyt_skip,
          ...
          gt_e071      TYPE /atrm/cl_transport=>tyt_e071,
...
CLASS /atrm/cl_before_export IMPLEMENTATION.
  ...
  METHOD run.
    ...
    IF sy-subrc <> 0.
      stree( CHANGING messages = messages ).
    ENDIF.
  ENDMETHOD.
